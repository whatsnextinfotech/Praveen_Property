...
import { Container, Row, Col, Image, Card,Button, Carousel as BootstrapCarousel } from 'react-bootstrap'; // Import React Bootstrap's Carousel
...
import Psa1 from '../../assest/PSA/Psa1.jpeg'
import Psa2 from '../../assest/PSA/Psa2.jpeg'
import Psa3 from '../../assest/PSA/Psa3.jpeg'
import school from '../../assest/School/zion.png'
import hospital from '../../assest/Hospital/arokia.png'
import college from '../../assest/College/sri.png'


import './Facility.css';
const PraveenSaiHome = () => {
  // Animation variants
  // Animation variants
  const fadeIn = {
    hidden: { opacity: 0 },
    ...
    <Container fluid>
      ...
      <motion.div initial="hidden" animate="visible" variants={fadeIn} transition={{ duration: 0.5 }}>
        <Row className="text-center my-4">
          ...
          padding: '10px 20px',
          borderRadius: '10px'}}>Praveen Sai Home</h1>
          </Col>
        </Row>
      </motion.div>
    ...
    {/* price */}
      <motion.div initial="hidden" animate="visible" variants={fadeIn} transition={{ duration: 0.5 }}>
        ...
        <Col>
          ...
          <p><strong> Starting:</strong> 60,00,000   </p>
        </Col>
        </Row>
        <Row className="text-center">
        <Col>
          <Button variant="primary" className="download-button"  href={`${process.env.PUBLIC_URL}/Broucher/Broucher1.pdf`}  download>
            Download Brochure
          </Button>
        </Col>
      </Row>
        ...
        <div className="row align-items-center">
          ...
          >
            <div className="content-box reveal right">
              ...
              <li>Shraddha Children's Academy</li>
                  <li>R.C.M Hr.Sec School </li>
                  <li>BSSK School </li>
                  <li>Vels Global School</li>
                  <li>SKB Vidhyashram School</li>
        ...
        <div className="row align-items-center flex-md-row-reverse">
          ...
          >
            <div className="content-box reveal right">
              ...
              <ul className="Specification">
              <li>  TMG College</li>
              <li>  Dhanalakshmi College of Engineering  </li>
               <li> Madha Engineering College </li>
               <li> Sri Sairam Engineering College  </li>
               <li>Bharath Post Graduate College  </li>
        ...
        <div className="row align-items-center">
          ...
          >
            <div className="content-box reveal left">
              <h2>Hospital</h2>
              <ul className="Specification">
                  <li>Sharon Hospital </li>
                  <li>Annai Arul Hospital</li>
                  <li>Saradha Hospital</li>
                  <li>Hindu Mission Hospital</li>
                  <li>Kasthuri Hospital</li>
                </ul>
            </div>
          </motion.div>
        </div>
