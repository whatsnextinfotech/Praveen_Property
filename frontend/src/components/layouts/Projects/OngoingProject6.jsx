    ...
    <Container fluid>
      ...
      <motion.div initial="hidden" animate="visible" variants={fadeIn} transition={{ duration: 0.5 }}>
        <Row className="text-center my-4">
          ...
          padding: '10px 20px',
          borderRadius: '10px'}}>Praveen Sai Garden</h1>
          </Col>
        </Row>
      </motion.div>
    ...
    {/* price */}
      <motion.div initial="hidden" animate="visible" variants={fadeIn} transition={{ duration: 0.5 }}>
        ...
        <Col>
          ...
          <p><strong> Starting:</strong>  21,60,000 <strong>/ Ending:</strong>28,87,500  </p>
        </Col>
        </Row>
        <Row className="text-center">
        <Col>
          <Button variant="primary" className="download-button"  href={`${process.env.PUBLIC_URL}/Broucher/Broucher3.pdf`}  download>
            Download Brochure
          </Button>
        </Col>
      </Row>
          ...
          >
            <div className="content-box reveal right">
              ...
              <li>Crescent School</li>
                  ...
                  <li>Anathavalli Matric. Hr.Sec.School.</li>
          ...
          >
            <div className="content-box reveal right">
              ...
              <li>  VIT College  </li>
               ...
               <li>Tagore Medical & Engineering College  </li>
          ...
          >
            <div className="content-box reveal left">
              ...
              <ul className="Specification">
                  ...
                  <li>Chettinadu Hospital</li>
                  <li>SRM Medical Hospital</li>
                  <li>Deepam Hospital</li>
                  <li>One Health Super Specialty Hospital</li>
                </ul>
            </div>
          </motion.div>
        </div>
...
export default PraveenSaiGarden;
