    ...
    <Container fluid>
      ...
      <motion.div initial="hidden" animate="visible" variants={fadeIn} transition={{ duration: 0.5 }}>
        <Row className="text-center my-4">
          ...
          padding: '10px 20px',
          borderRadius: '10px'}}>Praveen Marvel</h1>
          </Col>
        </Row>
      </motion.div>
    ...
    {/* price */}
      <motion.div initial="hidden" animate="visible" variants={fadeIn} transition={{ duration: 0.5 }}>
        ...
        <Col>
          ...
          <p><strong> Starting:</strong> 1,77,00,000 <strong>/ Ending:</strong>1,83,00,000  </p>
        </Col>
        </Row>
      ...
      <motion.div initial="hidden" animate="visible" variants={fadeIn} transition={{ duration: 0.5 }}>
        ...
        <Col>
          ...
          <p>  Preungalathur, Nedungundram.</p>
        </Col>
        </Row>
      </motion.div>
      ...
      <Container className="d-flex justify-content-center">
        ...
        <Col xs={6} md={2} className="d-flex flex-column align-items-center mx-2">
          ...
          <p className='Street'style={{width:'100px'}} >CCTV</p>
        </Col>
                </Row>
              </Container>
            </Col>
        ...
        <div className="row align-items-center">
          ...
          >
            <div className="content-box reveal right">
              ...
              <li>Vellammal School</li>
                  <li>Global school</li>
                  <li>SSM school</li>
                  <li>GKM Vidhyashram School</li>
                  <li>Annai Velankani School</li>
                  <li>Zion School</li>
              </ul>
            </div>
          </motion.div>
          ...
          >
            <div className="content-box reveal right">
              ...
              <li>  Sri Balaji Arts & Science college  </li>
               <li> Crescent Institute of Science Technology </li>
               <li> GKM College of Engineering  </li>
               <li>Sri Ramanujar Engineering College  </li>
