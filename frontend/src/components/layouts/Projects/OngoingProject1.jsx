...
const PraveenBloosom = () => {
  ...
  const responsive = {
    ...
    mobile: { breakpoint: { max: 464, min: 0 }, items: 1,  partialVisibilityGutter: 0, width: '100%'},
  };
    ...
    <Container fluid>
      ...
      <motion.div initial="hidden" animate="visible" variants={fadeIn} transition={{ duration: 0.5 }}>
        <Row className="text-center my-4">
          ...
          padding: '10px 20px',
          borderRadius: '10px'}}>Praveen Bloosom</h1>
          </Col>
        </Row>
      </motion.div>
    ...
    {/* price */}
      <motion.div initial="hidden" animate="visible" variants={fadeIn} transition={{ duration: 0.5 }}>
        ...
        <Col>
          ...
          <p className='price' ><strong> Starting:</strong> 57,68,000  <strong>/ Ending:</strong>59,10,000  </p>
        </Col>
        </Row>
      </motion.div>
